...
const siteConfig = {
	title: 'Zextras Contacts', // Title for your website.
	tagline: '',
	url: 'https://doc.dev.zextras.com/', // Your website URL
	baseUrl: `/iris/zapp-contacts/${  `${process.env.BRANCH_NAME  }/` || ''}`, // Base URL for your project */
	// For github.io type URLs, you would set the url and baseUrl like:
	//   url: 'https://facebook.github.io',
	//   baseUrl: '/test-site/',

	// Used for publishing and more
	projectName: 'com_zextras_zapp_contacts',
