Summary:            Contacts app for Zextras
Name:               zextras-zapp-contacts
Version:            0.0.19
Release:            1
License:            PROPRIETARY
Source:             com_zextras_zapp_contacts.zip
Requires:           zimbra-core zextras-zapp-shell
AutoReqProv:        no
URL:                https://zextras.com

%description
Contacts app for Zextras

%install
mkdir -p %{buildroot}/opt/zimbra/zimlets
cp %{_sourcedir}/com_zextras_zapp_contacts.zip \
...
/opt/zimbra/zimlets/com_zextras_zapp_contacts.zip
